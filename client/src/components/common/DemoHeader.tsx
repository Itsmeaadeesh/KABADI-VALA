    ...
    <>
      ...
      <header className="sticky top-0 z-50 bg-slate-900 text-white border-b border-slate-800 shadow-md">
        <div className="max-w-7xl mx-auto px-3 sm:px-6 h-14 sm:h-16 flex items-center justify-between gap-2 sm:gap-4">
          ...
          >
            <div className="w-8 h-8 sm:w-9 sm:h-9 bg-emerald-600 group-hover:bg-emerald-500 text-white rounded-xl flex items-center justify-center font-black shadow-md shadow-emerald-950/40 transition">
          ...
          <div className="flex items-center bg-slate-800/90 p-1 rounded-xl border border-slate-700/80">
            <button
              ...
              className={`px-2.5 sm:px-3 py-1 rounded-lg text-xs font-bold transition flex items-center gap-1.5 ${
                isCollectorActive
          ...
          <div className="flex items-center gap-1.5 sm:gap-2.5 flex-shrink-0">
            ...
            <button
              ...
              className="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg bg-amber-500 hover:bg-amber-400 text-slate-950 font-black text-xs transition shadow-xs"
            ...
            <div className="inline-flex items-center bg-slate-800 rounded-lg p-0.5 border border-slate-700 text-xs">
              ...
              {(['en', 'hi', 'mr'] as Language[]).map((lang) => (
                <button
                  ...
                  className={`px-1.5 sm:px-2 py-0.5 font-bold rounded-md transition ${
                    language === lang
