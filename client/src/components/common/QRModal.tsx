...
export const QRModal: React.FC<QRModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-slate-900/80 backdrop-blur-sm animate-fade-in overflow-y-auto">
      <div className="bg-white rounded-3xl max-w-sm w-full p-4 sm:p-6 shadow-2xl border border-slate-100 text-center relative animate-scale-up max-h-[92vh] overflow-y-auto my-auto">
        <button
          onClick={onClose}
