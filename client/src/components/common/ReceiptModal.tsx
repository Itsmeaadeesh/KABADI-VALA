...
export const ReceiptModal: React.FC<ReceiptModalProps> = ({ receiptData, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/80 backdrop-blur-sm animate-fade-in print:p-0 print:bg-white">
      <div className="bg-white rounded-3xl max-w-md w-full p-6 shadow-2xl border border-slate-200 relative animate-scale-up print:shadow-none print:border-none print:w-full">
        <button
          onClick={onClose}
